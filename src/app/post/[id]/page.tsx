    ...
    <div className="app-shell">
      ...
      <div className="page-content p-4">
        ...
        <div className="flex items-center gap-3 bg-white rounded-[12px] p-3.5 border border-[#EDE0C8] mb-6">
          ...
          <span className="text-[11px] font-semibold px-3 py-1.5 rounded-full" style={{background:'#F5ECD7',color:'#6B3F1F'}}>프로필 보기</span>
        </div>
        ...
        <div className="flex gap-2.5">
          <button
            ...
            className="flex-1 flex items-center justify-center gap-2 py-3.5 rounded-[12px]"
            style={{background:'#F5ECD7',border:'none',cursor:'pointer'}}
          >
          ...
          <button
            ...
            className="flex-[2] flex items-center justify-center gap-2 py-3.5 rounded-[12px]"
            style={{background:'#6B3F1F',border:'none',cursor:'pointer'}}
          >
